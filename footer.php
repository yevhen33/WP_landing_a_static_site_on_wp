<div class="question">
        ...
        <div class="reply">
            <div class="reply__body">
                ...
                <?php 
                  echo do_shortcode('[contact-form-7 id="151" title="Форма заявки"]');
                ?>
            </div>
        </div>
        <footer>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDySY8hrMvJbDt1ZatRr7xZK9cNqE8VN3w"></script> 
