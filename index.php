...
?>
                ...
                <ul class="glide__slides">
                    <?php 
                        ...
                        $posts = get_posts( array(
                            ...
                            'orderby'     => 'date',
                            // 'order'       => 'DESC', // порядок вывода - от последнего к первому
                            'order'       => 'ASC', // порядок вывода - от первого к последнему
                            'post_type'   => 'post',
        ...
        <div class="specialists" id="specialists">
            <div class="container">
                <div class="title"><?php the_field('command_title'); ?></div>
                <div class="row">
                    <div class="col-lg-10 offset-lg-1">
                        <?php 
                            $image = get_field('command_img');
                            if (!empty($image)): ?>
                ...
                <div class="row">
                    <div class="col-lg-10 offset-lg-1">
                        <div class="toys__alert">
                            <span><?php the_field('question'); ?></span><?php the_field('answer'); ?> 
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <!-- <?php 
                            echo do_shortcode( '[yamap center="56.4485,42.3080" height="100%" controls="" zoom="4" type="yandex#map"][yaplacemark  name="mir detstva" coord="55.738164984877976,37.50722765922547" icon="islands#dotIcon" color="#1e98ff"][/yamap]' );
                        ?> -->
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="contacts__feed">
                            <?php echo do_shortcode('[contact-form-7 id="150" title="Форма отзывов"]'); ?>
                        </div>
                                ...
                                <?php 
                                    ...
                                    foreach( $posts as $post ){
                                        ...
                                        <div class="feedslider__title">
                                            <?php the_field('rew_name'); ?>
                                        </div>
                                        <div class="feedslider__text">
                                            <?php the_field('rew_text'); ?>
                                        </div>
                                    </li>
